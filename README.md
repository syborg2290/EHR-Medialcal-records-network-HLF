...
> peer lifecycle chaincode approveformyorg -C test -n health --package-id $CC_PACKAGE -v 1.0 -o orderer:7050 --sequence 31  
> peer lifecycle chaincode commit -C test -n health -v 1.0 -o orderer:7050 --sequence 31
